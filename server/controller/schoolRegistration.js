...
const createSchool = async (req, res) => {
    ...
    try {
      ...
      const newDB = new Sequelize(newDBConfig.database, newDBConfig.username, newDBConfig.password, {
...
//arrange the tables in the correct order because of the foreign key
    ...
    await SchoolUsers.sync();
      ...
      return res.status(200).json({ message: 'School Database and Table created successfully' });
    } catch (error) {
